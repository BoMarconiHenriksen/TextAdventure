    ...
    */
    public void createRooms() {
        ...
        startRoom = new Room(new Inventory(),"The room is moist and a brown glow emanates from the walls." 
                                +"\nIt has three doorways; One to the north, one to the east, and one to the south.",false);
        ...
        room2 = new Room(new Inventory(),"The room is long and dark, and you can barely see the walls around you.\n"
                                +"It has a pulsating portal to the west and a doorway to the east.");
        
        room3 = new Room(new Inventory(),"The room has a stony floor, and dripping crystals hanging from the celing.\n"
                                +"It has three doorways; One to the north, one to the west, and one to the south.");
        
        room4 = new Room(new Inventory(),"The room is a dead end.\n"
                                +"Your only choice is to go back.");
        
        room5 = new Room(new Inventory(),"The room is narrow and blocked by rocks. You can barely move through.\n"
                                +"It has a dark tunnel to the south and a doorway to the west. ");
        
        room6 = new Room(new Inventory(),"The room is a wide tunnel, with strange colours coming from the cracks in the floor.\n"
                                +"It has a doorway to the north and a doorway to the south.");
        
        room7 = new Room(new Inventory(),"The room is a huge circle, with odd, flickering colours of red coming from the walls. "
                                + "It has a pulsating portal to the west and a doorway to the south.");
        
        room8 = new Room(new Inventory(),"The room is start-shaped, well lit from floating lights, calmly orbiting the ground.\n"
